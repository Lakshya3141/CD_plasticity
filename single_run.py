...
A = np.array([10, 10]) # optimal value of trait
B = np.array([3, 3]) # optimal value of plasticity under constant environment
a0 = np.array([10.01, 9.99]) # initial value for reaction norm elevation
b0 = np.array([0.01, 0.02]) # initial value for plasticity
...
sig_eps = np.sqrt(8) # variance in environmental fluctuations
...
tot = 80000 # total number of generations to run for
